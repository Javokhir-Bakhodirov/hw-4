...
const $IncomeText = document.querySelector("#incomeText") as HTMLElement;
const $ExpenseText = document.querySelector("#expenseText") as HTMLElement;
const $transactionList = document.querySelector(
    "#transactionList"
) as HTMLElement;
const $topCategories = document.querySelector("#topCategories") as HTMLElement;
...
const INCOME = JSON.parse(localStorage.getItem("incomes") as string) || [];
const EXPENSE = JSON.parse(localStorage.getItem("expenses") as string) || [];
...
const updateChart = () => {
    const totalIncome = INCOME.reduce(
        (acc: number, curr: TBalance) => (acc += curr.transactionAmount),
        0
    );
...
const updateTopCategories = () => {
    ...
    EXPENSE.forEach((expense: TBalance) => {
